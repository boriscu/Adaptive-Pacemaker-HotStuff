...
class BasicHotStuffHandler:
    ...
    def handle_precommit(
        ...
        self._logger.debug(f"Voted PRE_COMMIT for block {message.prepare_qc.block_hash[:8]}")
    ...
    def handle_precommit_vote(
        ...
        if qc is not None:
            ...
            self._logger.info(f"Formed precommitQC, updated lockedQC, broadcasting COMMIT")
